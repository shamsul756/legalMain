...
export default function FilterPanel() {
  ...
  const handleApplyFilters = () => {
    ...
    // আপনার আইনজীবীদের পেজের রাউট অনুযায়ী ডাইরেক্ট হবে
  ...
  return (
    <Card className="relative overflow-hidden bg-slate-950/40 border border-white/10 backdrop-blur-2xl p-8 shadow-2xl rounded-3xl" radius="none">
      ...
      <div className="gap-6 grid grid-cols-1 md:grid-cols-4 items-end">
        ...
        {/* Category Selector */}
        <div className="flex flex-col gap-2">
          <Label htmlFor="filter-category" className="text-xs font-bold uppercase tracking-wider text-slate-400">Practice Area</Label>
        ...
        {/* Location Selector */}
        <div className="flex flex-col gap-2">
          <Label htmlFor="filter-location" className="text-xs font-bold uppercase tracking-wider text-slate-400">Chamber / Region</Label>
          <div className="relative group">
